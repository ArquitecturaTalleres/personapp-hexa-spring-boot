...
public class TelefonoOutputAdapterMongo implements PhoneOutputPort {
    ...
    public Phone save(Phone phone) {
        log.debug("Into save on Adapter MongoDB (Telefono)");
        try {
    ...
    public Boolean delete(String number) {
        log.debug("Into delete on Adapter MongoDB (Telefono)");
    ...
    public List<Phone> find() {
        log.debug("Into find on Adapter MongoDB (Telefono)");
    ...
    public List<Phone> findAll() {
        log.debug("Into findAll on Adapter MongoDB (Telefono)");
        return telefonoRepositoryMongo.findAll().stream()
                .map(telefonoMapperMongo::fromAdapterToDomain)
                .collect(Collectors.toList());
    }
    ...
    public Phone findByNumber(String number) {
        log.debug("Into findByNumber on Adapter MongoDB (Telefono)");
